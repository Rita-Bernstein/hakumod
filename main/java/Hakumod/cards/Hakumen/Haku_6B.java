...
public class Haku_6B extends Haku_CustomCard {

	public static final String ID = "Haku_6B";
	...
	public static final String IMG_PATH = "Hakumod/img/cards/Haku_6B.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
    	...
    	AbstractDungeon.actionManager.addToTop(
    			new OkizemeAction(p, this, m, UtilsApplyEffect.VULNERABLE, this.magicNumber));
