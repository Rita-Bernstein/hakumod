...
public class LightPunch extends HakuCustomCard {

	public static final String ID = makeCardID(LightPunch.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
    	...
    	for (AbstractCard cardInHand : p.hand.group) {
    		if ( (cardInHand.cost == 0 || cardInHand.costForTurn == 0) && !(cardInHand instanceof LightPunch) ) {
