...
public class ClashAssault extends HakuCustomCard {

	public static final String ID = makeCardID(ClashAssault.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
    	...
    	act(new OkizemeAction(p, this, m, UtilsApplyEffect.VULNERABLE, this.magicNumber));
    }
	
	public AbstractCard makeCopy() {
		return new ClashAssault();
	}
