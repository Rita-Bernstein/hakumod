...
public class ChooseCardFromDeckAction extends AbstractGameAction{
	...
	public ChooseCardFromDeckAction(ArrayList<AbstractCard> cards, boolean toUpgrade, boolean toExhaust, boolean setCost, int costForCombat, boolean toRemoveFromDeck){
	...
	public ChooseCardFromDeckAction(ArrayList<AbstractCard> cards, boolean toUpgrade) {
